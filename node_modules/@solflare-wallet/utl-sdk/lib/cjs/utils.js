...
exports.getMultipleAccounts = exports.rpcRequest = exports.publicKeysToMap = void 0;
var lodash_1 = require("lodash");
var axios_1 = __importDefault(require("axios"));
var publicKeysToMap = function (keys) {
    return keys.reduce(function (acc, cur) {
        acc[cur.toString()] = true;
        return acc;
    }, {});
};
exports.publicKeysToMap = publicKeysToMap;
function rpcRequest(url, body, retries, timeoutSec) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1.default.post(url, body, { timeout: timeoutSec * 1000 })];
                case 1:
                    data = (_a.sent()).data;
...
function getMultipleAccounts(url, accounts, encoding) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    CHUNK_RPC_CALLS = 10;
                    rpcCalls = (0, lodash_1.chunk)(accounts, CHUNK_ACCOUNTS_PER_RPC_CALL).map(function (chunk) { return ({
                        jsonrpc: '2.0',
                        id: 42,
                    ...
                    allCalls = [];
                    batches = (0, lodash_1.chunk)(rpcCalls, CHUNK_RPC_CALLS);
                    i = 0;
                    _a.label = 1;
                case 1:
                ...
                case 3:
                    i++;
                    return [3 /*break*/, 1];
                case 4: return [2 /*return*/, (0, lodash_1.chain)(allCalls)
                        .flatten()
